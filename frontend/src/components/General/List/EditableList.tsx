...
const EditableList: React.FC<EditableListProps> = ({modalTitle, getListContent, deleteItemApi, addItemApi,
                                                       updateItemApi, itemToPropertyList, itemToAddModal, itemToUpdateModal, itemToLink}) => {
    ...
    return (
        <div>
            ...
            <List
                ...
                renderItem={(item) =>
                    <ItemCard item={item} itemToLink={itemToLink} deleteItem={deleteItem} itemToPropertyList={itemToPropertyList}
                                                updateItem={() => {
                    setIsAdd(false);
